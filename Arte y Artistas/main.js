...
const material0 = new THREE.MeshBasicMaterial( { color: 0xFFB626 } );
const material1 = new THREE.MeshBasicMaterial( { color: 0x3CD1DE});
...
//  Figura1.rotation.y = time / 1000;
    ...
    sol.position.x = 5 * Math.sin(Valuescroll * 0.005);
